        ...
        child: Column(
          children: [
            ...
            SideMenuItemDesktop(
              icon: Icons.people,
              text: 'Users',
              active: appProvider.currentPage == DisplayedPage.USERSCREEN,
              onTap: () {
                appProvider.changeCurrentPage(DisplayedPage.USERSCREEN);
                locator<NavigationService>().navigateTo(UserScreenRoute);
              },
            ),
            SideMenuItemDesktop(
              icon: Icons.shopping_cart,
              text: 'Transactions',
              active: appProvider.currentPage == DisplayedPage.ORDERSCREEN,
              onTap: () {
                appProvider.changeCurrentPage(DisplayedPage.ORDERSCREEN);
                locator<NavigationService>().navigateTo(OrdersScreenRoute);
              },
            ),
            SideMenuItemDesktop(
